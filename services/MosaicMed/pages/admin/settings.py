...
def display_departments():
    ...
    return [
        {
            'id': department.id,
            'korpus': department.korpus,
            'department_name': department.department_name,
            'registry_number': department.registry_number,
            'oid': department.oid,
            'start_date': department.start_date,
            'end_date': department.end_date,
            'f003mpcod': department.f003mpcod,
            'mis_kauz_korpus': department.mis_kauz_korpus
                ...
                dbc.CardBody([
                    ...
                    html.Div(
                        dash_table.DataTable(
                            ...
                            columns=[
                                {"name": "Корпус", "id": "korpus", "editable": True},
                                {"name": "Название подразделения", "id": "department_name", "editable": True},
                                {"name": "Реестровый номер", "id": "registry_number", "editable": True},
                                {"name": "OID", "id": "oid", "editable": True},
                                {"name": "Дата начала действия", "id": "start_date", "editable": True, "type": "datetime"},
                                {"name": "Дата окончания действия", "id": "end_date", "editable": True, "type": "datetime"},
                                {"name": "f003mpcod", "id": "f003mpcod", "editable": True},
                                {"name": "Корпус МИС КАУЗ", "id": "mis_kauz_korpus", "editable": True},
                            ],
