...
from pages.economic_reports.by_doctors_dispensary.query import sql_query_by_doctor_dispensary_adult_f1, \
    sql_query_by_doctor_dispensary_adult_f3, sql_query_by_doctor_dispensary_adult_f2

type_page = "by-doctor-dispensary-adult"
...
tab1_layout_by_doctor_dispensary = html.Div(
    [
...
def update_table(n_clicks, month_start, month_end, current_month, selected_status):
    ...
    sql_query_f1 = sql_query_by_doctor_dispensary_adult_f1(sql_conditions)
    sql_query_f2 = sql_query_by_doctor_dispensary_adult_f2(sql_conditions23)
    sql_query_f3 = sql_query_by_doctor_dispensary_adult_f3(sql_conditions23)
    list_months = []
