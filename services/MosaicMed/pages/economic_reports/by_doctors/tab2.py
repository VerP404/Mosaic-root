...
from pages.economic_reports.by_doctors.query import sql_query_by_doctors_stac_rep

type_page = "by-doctor-stac"
...
tab2_layout_by_doctor = html.Div(
    [
        ...
        html.Div(
            [
                html.H3('Отчет по врачам по стационарам', className='label'),
...
def update_table(n_clicks, month_start, month_end, current_month, selected_status):
    ...
    sql_query = sql_query_by_doctors_stac_rep(sql_conditions)
    list_months = []
