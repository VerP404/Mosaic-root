...
from pages.economic_reports.by_doctors_cel.query import sql_query_by_doctors_mest

type_page = "by-doctor-cel-mest"
...
tab1_layout_by_doctor_cel_mest = html.Div(
    [
        ...
        html.Div(
            [
                html.H3('Отчет по врачам оплаченные талоны местные', className='label'),
...
def update_table(n_clicks, month_start, month_end, current_month):
    ...
    columns, data = TableUpdater.query_to_df(engine, sql_query_by_doctors_mest, bind_params)
