...
from services.MosaicMed.pages.economic_reports.by_doctors_cel.query import sql_query_by_doctors_inog

type_page = "by-doctor-cel-inog"
...
tab1_layout_by_doctor_cel_inog = html.Div(
    [
        ...
        html.Div(
            [
                html.H3('Отчет по врачам оплаченные талоны иногородние', className='label'),
...
def update_table(n_clicks, month_start, month_end, current_month):
    ...
    columns, data = TableUpdater.query_to_df(engine, sql_query_by_doctors_inog, bind_params)
