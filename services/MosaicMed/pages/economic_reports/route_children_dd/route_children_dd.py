...
from pages.economic_reports.route_children_dd.query import sql_query_route_children
from pages.economic_reports.sv_pod.query import sql_qery_sv_pod
...
tab_layout_route_children = html.Div(
    [
        ...
        html.H3('Отчет по возрастам проведения детских профосмотров', className='label'),
        # Блок 2: Таблица
        html.Div(
            [
...
def update_table(n_clicks, month_start, month_end, current_month, selected_status):
    ...
    sql_query = sql_query_route_children(sql_conditions)
    list_months = []
